...
indeks moran
moran.test: to test spatial autocorrelation using Moran’s I
[-1,0), negative spatial autocorrelation
(0,1], positive spatial autocorrelation
0, radomized pattern
```{r}
# persiapan
...
```{r}
ggplot(ma2) + 
  geom_sf(aes(fill = cat.zeta), color = "black", size = 0.4) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
                  size = 2.5, color = "black", fontface="bold", max.overlaps = 10,
                  box.padding = 0.5, point.padding = 0.3) +
  theme_minimal() + 
  theme(legend.position = "right",
        legend.text = element_text(size = 5),          # Ukuran teks legend
        legend.title = element_text(size = 5),         # Ukuran judul legend
        legend.key.size = unit(0.6, "cm"),             # Ukuran simbol dalam legend
        legend.spacing.y = unit(0.1, "cm"),
        axis.title.x = element_blank(),  # Menghilangkan label sumbu x
        axis.title.y = element_blank()) +          # Jarak antar item dalam legend
  labs(title = "Relative Risk BYM", 
       subtitle = "2016 - INLA",
       fill = "Relative Risk")


ggplot(ma2) + 
  geom_sf(aes(fill = cat.zeta.2017), color = "black", size = 0.4) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) + 
  geom_sf(aes(fill = cat.zeta.2018), color = "black", size = 0.4) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) + 
  geom_sf(aes(fill = cat.zeta.2019), color = "black", size = 0.4) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) + 
  geom_sf(aes(fill = cat.zeta.2020), color = "black", size = 0.4) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) + 
  geom_sf(aes(fill = cat.zeta.2021), color = "black", size = 0.4) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) + 
  geom_sf(aes(fill = cat.zeta.2022), color = "black", size = 0.4) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
```{r}
ggplot(ma2) +
  geom_sf(aes(fill = cat.rr1.sep), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  theme_minimal() +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                  ...
                  size = 2.5, color = "black", fontface="bold", max.overlaps = 10,
                  box.padding = 0.5, point.padding = 0.3) +
  labs(title = "Relative Risk Spatio-Temporal Separable",
       subtitle = "2016 - INLA", 
       fill = "Relative Risk") +
  theme(legend.position = "right",
        axis.title.x = element_blank(),  # Menghilangkan label sumbu x
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.rr2.sep), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.rr3.sep), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
  ...
  labs(title = "Relative Risk Spatio-Temporal Separable",
       subtitle = "2018", 
       fill = "Relative Risk - INLA") +
  theme(legend.position = "right",
        axis.title.x = element_blank(),  # Menghilangkan label sumbu x
        axis.title.y = element_blank())

ggplot(ma2) +
  geom_sf(aes(fill = cat.rr4.sep), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.rr5.sep), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.rr6.sep), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID),
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.rr7.sep), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  ...
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                  ...
                  size = 2.5, color = "black", fontface="bold", max.overlaps = 10,
                  box.padding = 0.5, point.padding = 0.3) +
  labs(title = "Relative Risk Spatio-Temporal Inseparable",
       subtitle = "2016 - INLA", 
       fill = "Relative Risk") +
  theme(legend.position = "right",
        axis.title.x = element_blank(),  # Menghilangkan label sumbu x
...
Mapping MCMC
```{r}
hasil.mcmc <- read.csv("hasil mcmc_2.csv", sep = ";")

ma2 <- ma2 %>%
  left_join(hasil.mcmc, by = "ID")

mcmc.cutoff <- c(0, 0.5, 1, 1.5, 2, 3)
```

```{r}
cat.mcmc16.sep <- cut(hasil.mcmc$S16, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE,
                   levels = c("[0,0.5)", "[0.5,1)", "[1,1.5)", "[1.5,2)", "[2,3)"))
cat.mcmc17.sep <- cut(hasil.mcmc$S17, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE,
                   levels = c("[0,0.5)", "[0.5,1)", "[1,1.5)", "[1.5,2)", "[2,3)"))
cat.mcmc18.sep <- cut(hasil.mcmc$S18, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE,
                   levels = c("[0,0.5)", "[0.5,1)", "[1,1.5)", "[1.5,2)", "[2,3)"))
cat.mcmc19.sep <- cut(hasil.mcmc$S19, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE,
                   levels = c("[0,0.5)", "[0.5,1)", "[1,1.5)", "[1.5,2)", "[2,3)"))
cat.mcmc20.sep <- cut(hasil.mcmc$S20, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE,
                   levels = c("[0,0.5)", "[0.5,1)", "[1,1.5)", "[1.5,2)", "[2,3)"))
cat.mcmc21.sep <- cut(hasil.mcmc$S21, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE,
                   levels = c("[0,0.5)", "[0.5,1)", "[1,1.5)", "[1.5,2)", "[2,3)"))
cat.mcmc22.sep <- cut(hasil.mcmc$S22, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE,
                   levels = c("[0,0.5)", "[0.5,1)", "[1,1.5)", "[1.5,2)", "[2,3)"))
colors <- c("[0,0.5)" = "#eff3ff",   # Lebih cerah
            "[0.5,1)" = "#bdd7e7",   # Lebih intens
            "[1,1.5)" = "#6baed6",   # Biru medium
            "[1.5,2)" = "#3182bd",   # Biru lebih gelap
            "[2,3)" = "#08519c")     # Biru paling gelap

ma2 <- ma2 %>%
  mutate(cat.mcmc16.sep = cat.mcmc16.sep,
         cat.mcmc17.sep = cat.mcmc17.sep,
         cat.mcmc18.sep = cat.mcmc18.sep,
         cat.mcmc19.sep = cat.mcmc19.sep,
         cat.mcmc20.sep = cat.mcmc20.sep,
         cat.mcmc21.sep = cat.mcmc21.sep,
         cat.mcmc22.sep = cat.mcmc22.sep)

ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc16.sep), color = "black", size = 0.3) +
  scale_fill_manual(values = colors, name = "Relative Risk") +
  theme_minimal() +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc17.sep), color = "black", size = 0.3) +
  scale_fill_manual(values = colors, name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc18.sep), color = "black", size = 0.3) +
  scale_fill_manual(values = colors, name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc19.sep), color = "black", size = 0.3) +
  scale_fill_manual(values = colors, name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc20.sep), color = "black", size = 0.3) +
  scale_fill_manual(values = colors, name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc21.sep), color = "black", size = 0.3) +
  scale_fill_manual(values = colors, name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID),
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc22.sep), color = "black", size = 0.3) +
  scale_fill_manual(values = colors, name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
```{r}
cat.mcmc16.ins <- cut(hasil.mcmc$IN16, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc17.ins <- cut(hasil.mcmc$IN17, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc18.ins <- cut(hasil.mcmc$IN18, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc19.ins <- cut(hasil.mcmc$IN19, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc20.ins <- cut(hasil.mcmc$IN20, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc21.ins <- cut(hasil.mcmc$IN21, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc22.ins <- cut(hasil.mcmc$IN22, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)

ma2 <- ma2 %>%
  mutate(cat.mcmc16.ins = cat.mcmc16.ins,
         cat.mcmc17.ins = cat.mcmc17.ins,
         cat.mcmc18.ins = cat.mcmc18.ins,
         cat.mcmc19.ins = cat.mcmc19.ins,
         cat.mcmc20.ins = cat.mcmc20.ins,
         cat.mcmc21.ins = cat.mcmc21.ins,
         cat.mcmc22.ins = cat.mcmc22.ins)

ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc16.ins), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  theme_minimal() +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc17.ins), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc18.ins), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc19.ins), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc20.ins), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc21.ins), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID),
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc22.ins), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
```{r}
cat.mcmc16.spa <- cut(hasil.mcmc$SP16, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc17.spa <- cut(hasil.mcmc$SP17, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc18.spa <- cut(hasil.mcmc$SP18, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc19.spa <- cut(hasil.mcmc$SP19, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc20.spa <- cut(hasil.mcmc$SP20, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc21.spa <- cut(hasil.mcmc$SP21, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)
cat.mcmc22.spa <- cut(hasil.mcmc$SP22, 
                   breaks = mcmc.cutoff, include.lowest = TRUE, right = FALSE)

ma2 <- ma2 %>%
  mutate(cat.mcmc16.spa = cat.mcmc16.spa,
         cat.mcmc17.spa = cat.mcmc17.spa,
         cat.mcmc18.spa = cat.mcmc18.spa,
         cat.mcmc19.spa = cat.mcmc19.spa,
         cat.mcmc20.spa = cat.mcmc20.spa,
         cat.mcmc21.spa = cat.mcmc21.spa,
         cat.mcmc22.spa = cat.mcmc22.spa)

ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc16.spa), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  theme_minimal() +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc17.spa), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc18.spa), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc19.spa), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc20.spa), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc21.spa), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID),
...
ggplot(ma2) +
  geom_sf(aes(fill = cat.mcmc22.spa), color = "black", size = 0.3) +
  scale_fill_brewer(palette = "Blues", name = "Relative Risk") +
  geom_text_repel(aes(x = st_coordinates(st_centroid(geometry))[,1], 
                      y = st_coordinates(st_centroid(geometry))[,2], 
                      label = ID), 
